	...
	public class WorldMap2D_EditorInspector : Editor
	{
		...
		void ExecuteMoveTool ()
		{
			...
			for (int i = 0; i < points.Length; i++) {
				...
				var fmh_1357_50_638301411788825361 = mapTransform.rotation; newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
		...
		void ExecuteCityMoveTool ()
		{
			...
			var fmh_1540_57_638301411788848102 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
			                                           (handleControlID, position, rotation, size, eventType) =>
			                                           {
		...
		void ExecuteMountPointMoveTool ()
		{
			...
			var fmh_1629_57_638301411788851826 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
			                                           (handleControlID, position, rotation, size, eventType) =>
			                                           {
				Handles.RectangleHandleCap (handleControlID, position, rotation, size, eventType);
			});
